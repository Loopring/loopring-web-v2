...
export const MarketBlock = <C extends CoinKey<I>, I>({
    ...
    const { priceDollar, priceYuan } = tradeFloat
                        ...
                        <Box display={'flex'} alignItems={'center'}>
                          <Typography variant={'body2'} component={'span'} marginTop={1 / 2} marginRight={1}
                            ...
                            <Typography variant={'body2'} component={'div'} textOverflow={'ellipsis'} overflow={'hidden'} whiteSpace={'nowrap'}
                                    marginTop={1 / 2}>{t('labelAmount')} : {currencyUnit}{getThousandFormattedNumbers(Number((isUSD ? priceDollar : priceYuan).toFixed(2)))}</Typography>
                        </Box>
                    </Box>
