...
import { DepositWrapNew, TradeMenuList, useBasicTrade } from '../../tradePanel/components';
import React from 'react';

export const DepositPanelNew = withTranslation('common', {withRef: true})(<T extends IBData<I>, I>(
    {
        onDepositClick,
        depositBtnStatus,
        ...rest
    ...
    const props: SwitchPanelProps<'tradeMenuList' | 'trade'> = {
        ...
        panelList: [{
            key: "trade",
            element:React.useMemo(() => <DepositWrapNew<T, I> key={"transfer"}
                                              {...{
                                                  ...rest,
