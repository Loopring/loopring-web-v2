...
// symbol
export const ExportAccount_Approve_WaitForAuth = (props: PanelProps & WithTranslation) => {
    const propsPatch = {
...
export const ExportAccount_User_Denied = (props: PanelProps & WithTranslation) => {
    const propsPatch = {
...
// symbol
export const ExportAccount_Success = (props: PanelProps & WithTranslation) => {
...
// value symbol
export const ExportAccount_Failed = (props: PanelProps & WithTranslation) => {
    const propsPatch = {
