...
export const TokenAccessProcess = ({t, providerName}: WithTranslation & { providerName: string }) => {
    ...
    return <Box flex={1} display={'flex'} alignItems={'center'} justifyContent={'space-evenly'}
        ...
        <Typography component={'h3'} variant={'h2'} marginBottom={3}>{t('labelTokenAccess')}</Typography>
