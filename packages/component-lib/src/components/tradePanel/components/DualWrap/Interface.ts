...
export type DualDetailType = {
  dualViewInfo: DualViewBase & Partial<sdk.UserDualTxsHistory>
...
export type DualDetailProps = DualDetailType & {
  isRenew: boolean
  renewTargetPrice?: string
  renewDuration?: string
  onChange: (props: { isRenew: boolean; targetPrice: string; duration: string }) => void
