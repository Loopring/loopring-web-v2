...
import { Box, Divider, Link, Modal as MuiModal, Switch, Tooltip, Typography } from '@mui/material'
      ...
      >
        ...
        >
          ...
          <Box
            ...
            paddingX={3}
          >
            <ModifyParameter {...rest} isPriceEditable={isPriceEditable} />
          </Box>
        </Box>
      </MuiModal>
      <Box>
                ...
                onChange={
                  (e) =>
                    onChange({
                      ...
                      targetPrice: renewTargetPrice ?? dualViewInfo?.strike,
                      //TODO:
                      duration: renewDuration ?? dualViewInfo?.dualFilled,
                    })
                  // onChangeEvent({
