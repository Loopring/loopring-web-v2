    ...
    >
      {dualCalcData.dualViewInfo && priceSymbol && (
        <>
          ...
          >
            <DualDetail
              dualViewInfo={{ ...dualCalcData.dualViewInfo, ...dualCalcData.coinSell } as any}
              ...
              isRenew={dualCalcData.coinSell?.isRenew ?? false}
              renewTargetPrice={dualCalcData.dualViewInfo.strike}
              renewDuration={dualCalcData.dualViewInfo.term}
              ...
              onChange={(data) => {
                onChangeEvent({
                  tradeData: {
                    ...
                    maxRecurseProductDuration: data.duration,
