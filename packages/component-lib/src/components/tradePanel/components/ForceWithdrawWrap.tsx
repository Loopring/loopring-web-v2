      ...
      >
          ...
          >
            <Typography padding={2} maxWidth={490} variant={'body2'} whiteSpace={'pre-line'}>
              ...
              >
                ...
                withdraw the token from L2 to Ethereum L1. Usually only when you sent the token to
                the L2 account of a wrong Btrade address that doesn't support Loopring L2, you will
                need to do this so that you will be able to claim the token back.
              </Trans>
            </Typography>
          </PopoverPure>
        </Grid>
        ...
        <Grid item alignSelf={'stretch'} paddingBottom={0}>
          ...
          <Button
            ...
            loading={
              withdrawBtnStatus === TradeBtnStatus.LOADING && !getDisabled ? 'true' : 'false'
            }
