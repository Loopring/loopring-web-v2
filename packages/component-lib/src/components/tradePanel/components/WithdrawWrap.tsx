        ...
        <Grid item>
          ...
          >
            ...
            >
              ...
              >
                Your withdrawal will be processed in the next batch, which
                usually takes 30 minutes to 2 hours. (There will be a large
                delay if the Ethereum gas price exceeds 500 GWei.）
              </Trans>
            </Typography>
          </PopoverPure>
        </Grid>
          ...
          {!isToMyself ? (
            <>
              <TextField
                ...
                onChange={(event) =>
                  handleOnAddressChange(event?.target?.value)
                }
