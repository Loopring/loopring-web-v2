        ...
        <Grid item>
          ...
          >
            <Typography padding={2} maxWidth={490} variant={'body2'} whiteSpace={'pre-line'}>
              ...
              >
                Your withdrawal will be processed in the next batch, which usually takes 30 minutes
                to 2 hours. (There will be a large delay if the Ethereum gas price exceeds 500
                GWei.）
              </Trans>
            </Typography>
          </PopoverPure>
