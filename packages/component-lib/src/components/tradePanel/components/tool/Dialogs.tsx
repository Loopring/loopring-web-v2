    ...
    >
        ...
        <DialogContent>
            <DialogContentText id="alert-dialog-slide-description">
                <Trans i18nKey={'labelImpactExtraGreat'} tOptions={{value}}>
                    Your transaction amount will affect the pool price<Typography component={'span'}
                                                                                  color={'error'}> {<>{value}</>}% </Typography>.
        ...
        <DialogActions>
            <Button variant={'outlined'} size={'medium'}
                    onClick={(e) => handleClose(e as any)}> {t('labelDisAgreeConfirm')}</Button>
...
export const CancelAllOrdersAlert = withTranslation('common', {withRef: true})(({
    ...
    >
        ...
        <DialogActions style={{padding: '2.4rem', paddingTop: 0}}>
            <Button variant={'outlined'} size={'medium'}
                    onClick={(e) => handleClose(e as any)}> {t('labelCancel')}</Button>
            <Button variant={'contained'} size={'small'} onClick={(e) => {
                handleCancelAll()
                handleClose(e as any, true)
...
export const AlertNotSupport = withTranslation('common', {withRef: true})(({
    ...
    >
        ...
        <DialogActions>
            <Button variant={'outlined'} size={'medium'}
                    onClick={(e) => handleClose(e as any)}> {t('labelConfirm')}</Button>
        </DialogActions>
    </Dialog>
})
        ...
        <DialogContent>
            <DialogContentText id="alert-dialog-slide-description">
                <Trans i18nKey={'labelPriceExtraGreat'} tOptions={{compare: value ? t(value) : '> | <'}}>
                    The price you set is greater or less than 20% the market price. Are you sure you want to make this
                    order?
                </Trans>
            </DialogContentText>
        </DialogContent>
...
export const InformationForCoinBase = withTranslation('common', {withRef: true})(({
                                                                                      t,
                                                                                      open,
                                                                                      handleClose
                                                                                  }: WithTranslation & {
    ...
    >
        ...
        <DialogContent>
            <DialogContentText id="alert-dialog-slide-description">
                <Trans i18nKey={'labelNoticeForMetaMask'}>
                    Loopring only support and maintain MetaMask plugin for Wallet Connect, if your installed other
                    Wallet plugin,
                    please make sure it's the MetaMask popup: <img alt="MetaMask" style={{verticalAlign: 'text-bottom'}}
        ...
        <DialogActions>
            {/*<Button variant={'outlined'} size={'medium'} onClick={(e) => handleClose(e as any)}> {t('labelIKnow')}</Button>*/}
            <Button variant={'contained'} size={'small'} onClick={(e) => {
                handleClose(e as any, true)
            }} color={'primary'}>{t('labelIKnow')}</Button>
