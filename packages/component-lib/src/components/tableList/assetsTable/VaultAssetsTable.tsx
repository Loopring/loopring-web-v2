...
export type VaultIsolatedDataAssetsItem = {
  tokenA: {
    name: string
    amount?: string
    debt?: string
...
export type VaultIsolatedAssetsTableProps = {
  rawData: VaultIsolatedDataAssetsItem[]
  searchValue?: string
  pagination?: {
    pageSize: number
  }
  onRowClick?: (index: number, row: VaultIsolatedDataAssetsItem) => void
  allowTrade?: any
  tableHeight?: number
  onVisibleRowsChange?: (props: any) => void
  showFilter?: boolean
...
export const VaultIsolatedAssetsTablePropsMock: VaultIsolatedAssetsTableProps = {
  rawData: [
],
  searchValue: '',
  pagination: {
...
export const VaultIsolatedAssetsTable = withTranslation('tables')(
  (props: WithTranslation & VaultIsolatedAssetsTableProps) => {
    const {
      t,
      rawData,
      allowTrade,
    ...
    const getColumnModeAssets = (t: TFunction): Column<R, unknown>[] => [
      ...
      },
      {
        ...
        formatter: ({ row }) => {
          return (
            <Box height={'100%'} className={'textAlignRight'} display={'flex'} flexDirection={'column'} justifyContent={'center'}>
      ...
      },
      {
        ...
        formatter: ({ row }) => {
          ...
          return (
            <Box height={'100%'} className={'textAlignRight'} display={'flex'} flexDirection={'column'} justifyContent={'center'}>
            <Typography fontSize={'13px'}>
              {row.tokenA.amount ?? EmptyValueTag}
            </Typography>
            <Typography fontSize={'13px'}>
              {row.tokenB.amount ?? EmptyValueTag}
            </Typography>
          </Box>
          )
        },
...

      {
        ...
        formatter: ({ row }) => {
          return (
            <Box height={'100%'} className={'textAlignRight'} display={'flex'} flexDirection={'column'} justifyContent={'center'}>
            <Typography fontSize={'13px'}>
              {row.tokenA.debt ?? EmptyValueTag}
            </Typography>
            <Typography fontSize={'13px'}>
              {row.tokenB.debt ?? EmptyValueTag}
            </Typography>
          </Box>
          )
        },
