...
const getColumnModeRewardTable = (t: TFunction, chosenCardInfo?: string): Column<Row, unknown>[] => {
    return [
        {
            key: 'amount',
...
export const RewardTable = withTranslation('tables')(({chosenCardInfo, rawData, t}: RewardTableProps & WithTranslation) => {
