...
const FistWrap = ({onChangeIndex}: any) => {
    ...
    return <Box flex={1} display={'flex'} justifyContent={'center'} alignItems={'center'} height={'100%'}
                width={'100%'}>
        <Button variant={'outlined'} size={'small'} color={'primary'} onClick={handleOnClick}>go to next panel</Button>
    </Box>
}
