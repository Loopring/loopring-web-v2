...
import { DownloadIcon, NotificationIcon, SettingIcon, } from '@loopring-web/common-resources';
...
export const BtnDownload = ({
  ...
  const Description = () => <Link target={'_blank'} href='https://loopring.io'>{t(i18nDescription)}</Link>
