...
export const useOpenModals = () => {
    ...
    return {
        ...
        setShowTransfer: React.useCallback((state: ModalStatePlayLoad) => dispatch(setShowTransfer(state)), [dispatch]),
        setShowDeposit: React.useCallback((state: ModalStatePlayLoad ) => dispatch(setShowDeposit(state)), [dispatch]),
        setShowWithdraw: React.useCallback((state: ModalStatePlayLoad) => dispatch(setShowWithdraw(state)), [dispatch]),
