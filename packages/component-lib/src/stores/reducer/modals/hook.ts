...
export const useOpenModals = () => {
    ...
    return {
        ...
        setShowNFTTransfer: React.useCallback((state: ModalStatePlayLoad & Partial<NFTWholeINFO>) => dispatch(setShowNFTTransfer(state)), [dispatch]),
        setShowNFTDeposit: React.useCallback((state: ModalStatePlayLoad & Partial<NFTWholeINFO>) => dispatch(setShowNFTDeposit(state)), [dispatch]),
        setShowNFTWithdraw: React.useCallback((state: ModalStatePlayLoad & Partial<NFTWholeINFO>) => dispatch(setShowNFTWithdraw(state)), [dispatch]),
