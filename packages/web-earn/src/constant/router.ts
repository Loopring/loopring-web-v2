...
export const AssetL2TabEarnIndex = {
  ...
  ETHEREUM: [AssetTabIndex.Tokens, AssetTabIndex.Invests, AssetTabIndex.Rewards],
  GOERLI: [AssetTabIndex.Tokens, AssetTabIndex.Invests],
  Arbitrum: [AssetTabIndex.Tokens, AssetTabIndex.Invests, AssetTabIndex.Rewards],
}
