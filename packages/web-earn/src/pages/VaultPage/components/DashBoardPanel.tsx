...
export const VaultDashBoardPanel = ({
  ...
  const props = useVaultDashboard({ vaultAccountInfo: _vaultAccountInfo, showLeverage, closeShowLeverage })
  return <VaultDashBoardPanelUI {...props} vaultAccountInfo={_vaultAccountInfo.vaultAccountInfo} closeShowLeverage={closeShowLeverage} showLeverage={showLeverage}/>
}
