...
const VaultDashBoardPanelUI2: React.FC<VaultDashBoardPanelUIProps> = ({
  t,
  forexMap,
  theme,
  isMobile,
            ...
            <>
              ...
              >
                <VaultAssetsTable
                  ...
                  showFilter
                />
                <Button onClick={onClickPortalTrade} size={'large'} variant='contained' sx={{mt: 5, mb: 3,alignSelf: 'center', width: '200px'}}>
                  Portal Trade
                </Button>
              </Box>
              <Modal
