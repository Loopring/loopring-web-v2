...
export function useAccountModalForUI({t, etherscanBaseUrl, onClose, rest,}:
  ...
  }, [onClose, setShouldShow, setShowAccount, setShowResetAccount, setShowTransfer, setShowWithdraw])
  ...
  }, [goDeposit, chainInfos, isSupport, updateDepositHash, clearDeposit, account, etherscanBaseUrl, onSwitch, onCopy, onViewQRCode, onDisconnect, addressShort, onQRClick, rest, t, onBack, lockBtn, unlockBtn, backToDepositBtnInfo, closeBtnInfo, depositProps.tradeData.belong, depositProps.tradeData.tradeValue, TryNewTransferAuthBtnInfo, backToTransferBtnInfo, TryNewWithdrawAuthBtnInfo, backToWithdrawBtnInfo, backToUpdateAccountBtnInfo, backToUnlockAccountBtnInfo, backToResetAccountBtnInfo, setShowAccount, setShowDeposit, goUpdateAccount])
