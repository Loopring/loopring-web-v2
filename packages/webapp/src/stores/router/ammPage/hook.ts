...
import { updatePageAmmExit, updatePageAmmJoin, updatePageAmmJoinBtn, updatePageAmmExitBtn, updatePageAmmCommon, } from './reducer';
...
export function usePageAmmPool(): PageAmmPoolStatus & {
    ...
    return {
        ...
        updatePageAmmJoinBtn: React.useCallback((pageAmmJoin: RequireOne<PageAmmJoin, never>) => {
        ...
        updatePageAmmExitBtn: React.useCallback((pageAmmJoin: RequireOne<PageAmmExit, never>) => {
