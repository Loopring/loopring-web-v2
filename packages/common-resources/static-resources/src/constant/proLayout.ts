...
const basicLayout = {
    ...
    layouts: {
        'xlg':[
            ...
            {i:'market2',   x:8,y:10,w:4,h:88,minW:4,minH:36},
            {i:'chart',     x:13,y:10,w:12,h:88,minW:6,minH:32},
            {i:'orderTable',x:5,y:64,w:20,h:55,minW:6,minH:36},
        ],
        'lg':[
            {i:'toolbar',   x:0,y:0,w:24,h:9,minW:24,minH:9},
            {i:'walletInfo',x:0,y:10,w:4,h:23,minW:4,minH:22},
            {i:'spot',      x:0,y:14,w:4,h:94,minW:4,minH:70},
            {i:'market',    x:4,y:10,w:4,h:73,minW:4,minH:58},
            {i:'market2',   x:8,y:10,w:4,h:73,minW:4,minH:58},
            {i:'chart',     x:13,y:10,w:12,h:73,minW:6,minH:32},
        ...
        'sm': [
            ...
            {i:'walletInfo',x:0,y:10,w:3,h:23,minW:3, minH:22},
            {i:'spot',      x:0,y:14,w:3,h:71,minW:3, minH:70},
        ...
        'xxs': [
            ...
            {i:'market',    x:3,y:10,w:3,h:58,minW:3,minH:58},
            {i:'market2',   x:0,y:0, w:0,h:0, minW:0,minH:0},
            {i:'chart',     x:3,y:10,w:3,h:36,minW:6,minH:32},
