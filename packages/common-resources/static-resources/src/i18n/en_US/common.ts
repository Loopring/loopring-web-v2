...
export default {
  ...
  labelDepositWaitForAuth:
    "Please confirm your deposit of {{value}} {{symbol}} to {{to}} L2.",
  ...
  labelNFTDepositBtn: "Deposit L2 NFT",
  nftDepositTitle: "Deposit L2 NFT",
  ...
  labelNFTTokenDepositWaitForAuth: "Please confirm you want to deposit {{symbol}} on L2.",
