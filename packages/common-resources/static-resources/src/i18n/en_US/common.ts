export default {
    ...
    depositDescription: 'Once your deposit is confirmed on Ethereum, it will be added to your balance within 2 minutes.',
    ...
    withdrawDescription: 'Your withdrawal will be processed in the next batch, which usually takes 30 minutes to 2 hours. (There will be a large delay if the Ethereum gas price exceeds 500 GWei.）',
