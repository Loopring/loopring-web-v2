...
export default {
  ...
  labelReferralsClaimEarning: 'Claim Rewards ',
  ...
  labelDefiWithdrawFee: "<p>Finally, there will be an additional 0.05% exit fee incurred, which will be charged at redemption time.</p>",
