export default {
    ...
    labelDepositFailed:'Deposit <1>{{value}}</1><2>{{symbol}}</2> failed!',
    labelDepositSubmit: 'Deposit <1>{{value}}</1><2>{{symbol}}</2> submitted.',
    labelWithdrawInProgress: 'Withdraw for now...',
    labelWithdrawFailed:'Withdraw <1>{{value}}</1><2>{{symbol}}</2> failed!',
    labelWithdrawSuccess: 'Withdraw <1>{{value}}</1><2>{{symbol}}</2> successfully!',
    labelTransferInProgress: 'Transfer for now...',
    labelTransferFailed:'Transfer <1>{{value}}</1><2>{{symbol}}</2> failed!',
    labelTransferSuccess: 'Transfer <1>{{value}}</1><2>{{symbol}}</2> successfully!',
