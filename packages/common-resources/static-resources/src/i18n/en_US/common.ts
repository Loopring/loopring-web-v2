...
export default {
  ...
  labelPleaseInputWalletAddress: "Please input address, ENS, or Account ID",
  ...
  labelActivatedAccountDeposit:
    "Please deposit to activate your L2 account.",
  ...
  labelWalletConnectProcessDescribe:
    "Please wait for the WalletConnect provider to finish processing.",
  ...
  labelRejectOrError:
    "Request was rejected or some unknown error occurred, please try again.",
  ...
  labelQuotePageFavourite: "Favorites",
  ...
  labelUpdateAccSigWarning:
    "Your Wallet does not support this signature method, it will try another one.",
  ...
  labelTryAnother: "Try Another Signature Method",
  labelCancel: "Cancel",
  describeTitleNoAccount:
    "As Ethereum's first ever zkRollup, Loopring L2 allows you to avoid costly gas fees and network congestion with the same security as Ethereum L1 - 100x cheaper and faster.",
  describeTitleOpenAccounting:
    "Your deposit has been submitted to Ethereum L1.\n Please wait...",
  ...
  labelKnown: "OK",
  labelResetAccount: "Reset L2 Account",
  ...
  labelExportAccountSuccess: "Account export was successful!",
  labelExportAccountFailed: "Account export has failed!",
  ...
  labelSlippageAlert:
    "Your slippage tolerance is rather high. This could result in fewer tokens received.",
  ...
  labelSwapCancelled: "Swap is canceled.",
  ...
  labelCancelAllOrders: "Confirm canceling all orders?",
  ...
  labelAgreeConfirmNotShowAgain: "I know & do not show again",
  labelInvalidCID: "Invalid CID",
  labelInvalidAddress: "Invalid address or ENS",
  ...
  labelWalletInputGuardianCode: "Enter 6 digit approval code",
  ...
  labelLockAccountSuccess: "Account Successfully Locked",
  labelLockAccountFailed: "Account Lock Failed",
  ...
  labelYourBalance: "Your Layer 2 has: {{balance}}",
  ...
  labelTxGuardian_recovery: "Recover Wallet",
  ...
  depositTitleAndActive: "Add Assets from My L1 & Activate",
  ...
  labelL2toL1Failed: "Sending {{value}} {{symbol}} to L1 has failed!",
  labelL2toL1Success: "Sending {{value}} {{symbol}} to L1 was successful!",
  labelL2toL2InProgress: "Processing...",
  labelL2toL2Failed:
    "Sending {{value}} {{symbol}} from my Loopring L2 to anther Loopring L2 failed!",
  labelL2toL2Success: "Sending {{value}} {{symbol}} was successful!",
  ...
  labelNFTTokenDepositWaitForAuth:
    "Please confirm you want to send Loopring L2 {{symbol}}",
  nftMintDescription:
  ...
  labelSendAssetHowto: "Where would you like to send your tokens?",
  ...
  labelToAddressShouldLoopring: "The recipient is not a Loopring L2 account",
  ...
  labelENSShouldConnect:
    "Receive address is an ENS, please connect wallet to check Ethereum address",
  labelToken: "Token",
  ...
  labelWalletTypeDes:
    "Please confirm the address origin again to ensure the assets are not mistakenly sent to an exchange address.",
  ...
  labelEOADes:
    "This wallet address is not a smart wallet that binds with a smart contract (MetaMask, GameStop, imToken, Ledger, Trezor, etc...).",
  labelLoopringDes:
  ...
  labelNonExchangeTypeDes:
    "eg: Loopring Wallet, Metamask, GameStop, Coinbase Wallet, imtoken, Ledger, Trezor... EOA wallet",
