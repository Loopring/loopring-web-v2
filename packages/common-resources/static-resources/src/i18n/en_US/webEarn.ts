...
export default {
  ...
  labelVault: 'Portal',
  labelInvestDualDes1: 'Experience the leading Structured Product On-Chain',
  labelInvestDualDes2: 'Buy the dip or sell high at your desired price, all while earning high yields',
  labelPortalDes1: 'Trade with CEX Liquidity',
  labelPortalDes2: 'Block Trade is a feature that enables users to seamlessly trade tokens with near zero price impact by aggregating multiple liquidity sources across crypto',
