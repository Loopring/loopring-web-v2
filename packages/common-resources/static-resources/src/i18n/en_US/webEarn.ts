...
export default {
  ...
  labelPortalDes1: 'Unlock the Leveraged Trading Potential',
  ...
  labelBtradeDes2: 'Block Trade is a feature that enables users to seamlessly trade tokens with near zero price impact by aggregating multiple liquidity sources across crypto',
