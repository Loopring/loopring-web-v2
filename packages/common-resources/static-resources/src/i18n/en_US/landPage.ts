export default {
  ...
  labelUnlockThePowerOfLeveragedTradingDes: 'Experience secure futures trading with up to 50x leverage, giving you more buying power to potentially amplify your gains. Our unique design ensures your leveraged positions remain safe, even during extreme market volatility.',
  ...
  labelProvenAppSpecificZKRollupDes: 'Loopring processes 2,000+ trades per second with the security guarantees of Ethereum.',
  labelAuditedAndSecure: 'Audited and Secure',
  labelAuditedAndSecureDes: 'Loopring\'s smart contracts and ZK Circuits have been audited by third-party security firms.',
  labelBringingCEXToDeFi: 'Bringing CEX to DeFi',
  labelBringingCEXToDeFiDes: 'Loopring brings the high-performance of CEXs to DeFi, without sacrificing security.',
  labelReadyForDevelopersDes2: 'Build scalable payment apps, decentralized exchanges, and NFT marketplaces on Ethereum with Loopring\'s battle-tested ZK-Rollup technology. Get started with open-source protocols, documentation, a robust API, SDK, and a fully secure mainnet.',
}
