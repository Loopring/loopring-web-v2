export default {
    ...
    labelWalletIdentityH1: 'OWN AN IDENTITY',
    labelWalletIdentityH2: 'Your wallet is your continuous identity',
    ...
    labelWalletUsageDetail: "Loopring Wallet integrates Loopring's zkRollup layer2 scaling\nprotocol to greatly raise speeds and lower fees, while inheriting\nthe same security guarantees as the Ethereum mainnet.",
