export default {
    ...
    labelWalletUsageDetail: "Loopring Wallet integrates Loopring's zkRollup layer2 scaling protocol to raise speeds and lower \n fees by 1000x, while inheriting the absolute same security guarantees as Ethereum mainnet.",
