export default {
    ...
    labelNoticeForMetaMask: 'Loopring only support and maintain MetaMask plugin for Wallet Connect, \nif your installed other Wallet plugin, please make sure it\'s the MetaMask popup: <1></1>.',
