...
export default {
  ...
  labelL2toL1EnterToken: "选择提现代币",
  withdrawDescription:
    "提现操作会被提交到以太坊的下一个区块，一般会在<1>30分钟到2小时</1>内到账。（如果以太坊的GAS价格<5>超过500GWei</5>的话，可能会存在<3>长时间的延迟</3>）",
  labelSendL1Btn: "提现",
  labelSendL1DeployBtn: "Deploy & Send",
  labelL2toL1BtnExceed: "超过最大提现数{{amt}}!",
  labelL2toL1Address: "Ethereum 地址",
  labelL2toL1AddressInput: "输入地址",
  labelL2toL1MyAddress: "to My Layer 1",
  labelL2toL1Fee: "请选付费代币",
  withdrawTypeLabelFast: "快速提现（最快15秒到账）",
  withdrawTypeLabelStandard: "普通提现（约25分钟）",
  labelL2toL1Fast: "快速提现",
  labelL2toL1Standard: "普通提现",
  labelL2toL1LinkRecent: "最近提现记入",
  labelL2toL2Title: "Send to Another L2",
  labelL2toL2EnterToken: "选择转账代币",
  transferDescription:
    "迅速转账到任何有效的以太坊地址。转账前请务必确认该地址可以接受路印的二层转账。",
  labelL2toL2Btn: "转账",
  labelL2toL2Address: "地址",
  labelL2toL2AddressInput: "请输入转到的地址",
  labelL2toL2Memo: "备注(非必填)",
  labelL2toL2MemoPlaceholder: "请输入备注信息",
  labelL2toL2FeeChoose: "请选付费代币",
  labelL2toL2Fee: "费用",
  labelL2toL2FeeNotEnough: "余额不足",
  labelL2toL2LinkRecent: "最近转账记入",
  ...
  labelL1toL2WaitForAuth: "请确认充值 {{value}} {{symbol}} 到 {{to}} L2",
  labelL1toL2Denied: "充值 {{value}} {{symbol}} 已被用户拒绝",
  labelL1toL2Failed: "充值 {{value}} {{symbol}} 失败",
  labelL1toL2Submit: "充值 {{value}} {{symbol}} 已提交",
  labelL1toL2NeedApprove: "允许LOOPRING EXCHANGE授权{{symbol}}",
  labelL2toL1InProgress: "正在提现中...",
  labelL2toL1Failed: "提现 {{value}} {{symbol}} 失败!",
  labelL2toL1Success: "提现 {{value}} {{symbol}} 成功!",
  labelL2toL2InProgress: "正在转账中...",
  labelL2toL2Failed: "转账 {{value}} {{symbol}} 失败!",
  labelL2toL2Success: "转账 {{value}} {{symbol}} 成功!",
