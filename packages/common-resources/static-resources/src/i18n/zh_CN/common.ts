export default {
    ...
    labelDepositFailed: '充值 <1>{{value}}</1><2>{{symbol}}</2> 失败',
    labelDepositSubmit: '充值 <1>{{value}}</1><2>{{symbol}}</2> 已提交',
    labelWithdrawInProgress: '正在提现中...',
    labelWithdrawFailed: '提现 <1>{{value}}</1><2>{{symbol}}</2> 失败!',
    labelWithdrawSuccess: '提现 <1>{{value}}</1><2>{{symbol}}</2> 成功!',
    labelTransferInProgress: '正在转账中...',
    labelTransferFailed: '转账 <1>{{value}}</1><2>{{symbol}}</2> 失败!',
    labelTransferSuccess: '转账 <1>{{value}}</1><2>{{symbol}}</2> 成功!',
    ...
    labelCreateAccountSubmit: '开通二层账户 {{value}} {{symbol}} 的充值以提交成功',
    labelCreateAccountFailed: '开通二层账户{{value}} {{symbol}} 的充值失败',
}
