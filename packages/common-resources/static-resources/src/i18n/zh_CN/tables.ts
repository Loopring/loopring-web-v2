export default {
  ...
  labelAMM: "AMM",
  labelSend: "Send",
  labelSendL2: "Send Loopring L2",
  labelSendL1: "Send L1",
  labelReceive: "Receive",
  labelL2toL1Action: "提现",
  labelTrade: "交易",
  labelToken: "币种",
  labelAmount: "总量",
  labelAvailable: "可用额度",
  ...
  labelTxFilterSendL2: "Send Loopring L2",
  ...
  labelMaker: "Maker",
  labelTaker: "Taker",
  labelNFTTypeDEPOSIT: "Receive",
  labelNFTTypeTRANSFER: "Send Loopring L2",
  labelNFTTypeWITHDRAWAL: "Send L1",
  labelNFTTypeWITHDRAW: "Send L1",
  labelMint: "Mint",
  labelNFTTypeMINT: "Mint",
  labelTxNFTFilterALL: "All",
  labelTxNFTFilterDEPOSIT: "Receive",
  labelTxNFTFilterWITHDRAW: "Send Loopring L2",
