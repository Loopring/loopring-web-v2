...
export default {
  ...
  labelInvestDualDes1: 'Trade with CEX Liquidity',
  labelInvestDualDes2: 'Block Trade is a feature that enables users to seamlessly trade tokens with near zero price impact by aggregating multiple liquidity sources across crypto',
  labelPortalDes1: 'Experience the leading Structured Product On-Chain',
  labelPortalDes2: 'Buy the dip or sell high at your desired price, all while earning high yields',
  labelBtradeDes1: 'Unlock the Leveraged Trading Potential',
  labelBtradeDes2: 'Seamlessly borrow tokens against your collateral, paving the way for leveraged trading opportunities. By bridging decentralized and centralized exchanges, Loopring Portal broadens your trading horizon, granting access to tokens beyond the Ethereum network.',
