...
AMM swap | - | 2,750 GAS [2] | ${AMM_TRADING_FEES.default+0.2%(liquidity provision fees)}% | ${AMM_TRADING_FEES.vip_1+0.2%(liquidity provision fees)}% | ${AMM_TRADING_FEES.vip_2+0.2%(liquidity provision fees)}% | ${AMM_TRADING_FEES.vip_3+0.2%(liquidity provision fees)}% | ${AMM_TRADING_FEES.vip_4+0.2%(liquidity provision fees)}%
